...
(function (factory) {
    ...
    angular.module('ng-sortable', [])
        ...
        .directive('ngSortable', ['$parse', function ($parse) {
            ...
            return {
                ...
                link: function (scope, $el, attrs) {
                    ...
                    function _remove(evt, options) {

                        var preItems;

                        // when target parentNode is trash node,it means the target is to drag out to remove
                        if (source && options.group.pull !== 'clone' && evt.item.parentNode && evt.item.parentNode.nodeName === "TRASH") {
        ...
        .directive("sortableTrash", function () {
            ...
            return {
                restrict: "E",
                template: "<ul ng-sortable='options'><li ng-repeat='item in items track by $index'></li></ul>",
                link    : function (scope) {
                    scope.items = [];
                    scope.options = {
                        onEnd: function () {
